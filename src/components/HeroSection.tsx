    ...
    backgroundPosition: 'center'
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2">
        ...
        delay: 0.3
          ...
          <svg width="60" height="60" viewBox="0 0 60 60" fill="none" className="text-gold">
            ...
            {/* Rays */}
            {[...Array(8)].map((_, i) => <line key={i} x1="30" y1="5" x2="30" y2="12" stroke="currentColor" strokeWidth="0.5" transform={`rotate(${i * 45} 30 30)`} opacity="0.6" />)}
          </svg>
        </motion.div>
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        delay: 0.5
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-gold mb-6 leading-tight">גלה מחדש את הכוח שבך</h1>

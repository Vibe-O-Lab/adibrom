        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-foreground/80 leading-relaxed">
              <p>
                מלווה נשים וגם גברים בתהליכי היזכרות וחיבור לכוחותיהם הפנימיים. 
                הדרך שלי נולדה מתוך משבר אישי עמוק וצמיחה דרך גלגל דרך השלום, 
                שלימד אותי לפגוש כל אתגר באהבה ולמצוא שפה של לב.
              </p>
